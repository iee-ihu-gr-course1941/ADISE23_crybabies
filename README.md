...
=================
   ...
   * [Περιγραφή Παιχνιδιού](#περιγραφή-παιχνιδιού)
      * [Βάση Παιχνιδιού](#βαση-παιχνιδιού)
   ...
   * [Περιγραφή API](#περιγραφή-api)
      * [Methods](#methods)
         ...
         * [Pawn](#piece)
            * [Ανάγνωση Pawns](#ανάγνωση-pawns)
            * [Ενημέρωση θέσης πιονιού](#ενημέρωση-θέσης-πιονιού)
            * [Ανάγνωση Πιονιών Παίκτη ](#ανάγνωση-πιονιών-παίκτη)
            * [Ανάγνωση Βημάτων Πιονιού ](#ανάγνωση-βημάτων-πιονιού)
         * [Player](#player)
 ...
 * Θα πρέπει να δημιουργήσετε στην Mysql την βάση με όνομα 'ludo' και να φορτώσετε σε αυτήν την βάση τα δεδομένα από το αρχείο schema.sql

 * Θα πρέπει να γράψετε το username σας και τον πιθανό password σας στο αρχείο dbconnect.php για να δουλεύει με την προσωπική σας βάση.
