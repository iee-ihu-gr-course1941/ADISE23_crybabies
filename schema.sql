...
BEGIN
	...
	SELECT  p_num, p_color INTO piece_num, piece_color FROM `pawns` WHERE x=x1 AND y=y1;
	
	UPDATE `pawns` SET p_num=piece_num, p_color=piece_color WHERE X=x2 AND Y=y2;
	UPDATE `pawns` SET p_num=NULL, p_color=NULL WHERE X=x1 AND Y=y2;
...
-- Dumping data for table ludo.pawns: ~121 rows (approximately)
INSERT INTO `pawns` (`x`, `y`, `p_color`, `p_num`, `sum`) VALUES
	(1, 1, NULL, NULL, NULL),
	(1, 2, NULL, NULL, NULL),
	(1, 3, NULL, NULL, NULL),
	(1, 4, NULL, NULL, NULL),
...
-- Dumping data for table ludo.pawns_empty: ~121 rows (approximately)
INSERT INTO `pawns_empty` (`x`, `y`, `p_color`, `p_num`, `sum`) VALUES
	(1, 1, NULL, NULL, NULL),
	(1, 2, NULL, NULL, NULL),
	(1, 3, NULL, NULL, NULL),
	(1, 4, NULL, NULL, NULL),
